...
def main():
    ...
    parser.add_argument('-i', "--interval", default=3, type=int, help='Sets the interval between sending message, in seconds')

    global g_args
    g_args = parser.parse_args()
    server = ThreadedTCPServer(('0.0.0.0', int(g_args.srv_port)), MyTCPHandler)
